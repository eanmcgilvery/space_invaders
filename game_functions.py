...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x,
    ...
    if button_clicked and not stats.game_active:
        pygame.mixer.init()
        pygame.mixer.music.load('sound_effects/Dark-Things.wav')
...
def fire_bullet(ai_settings, screen, ship, bullets, stats):
    ...
    if stats.game_active and stats.game_pause:
        if len(bullets) < ai_settings.bullets_allowed:
            ...
            shoot = pygame.mixer.Sound('sound_effects/Laser_Shoot.wav')
            shoot.play()


def alien_bullet(ai_settings, screen, aliens, alien_bullets):
...
def create_fleet(ai_settings, screen, aliens):
    ...
    for alien_number in range(number_aliens_x):
        ...
        create_alien2(ai_settings, screen, aliens, alien_number, 1.2)
